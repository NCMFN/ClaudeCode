...
def generate_manifests():
    ...
    note = "Note: LANL authentication schema does not directly encode 'digital sanitization (shortcut learning)' actions. The label comes entirely from redteam.txt.gz associations."
