...
> **50K+ stars** | **6K+ forks** | **30 位贡献者** | **支持 5 种语言** | **Anthropic 黑客马拉松获奖者**
...
<tr>
<td align="center"><b>简明指南</b><br/>设置、基础、理念。 <b>首先阅读此内容。</b></td>
...
```bash
/skill-create                    # 分析当前仓库
/skill-create --instincts        # 同时为持续学习生成本能
```
...
rules/
  common/          # 通用原则（始终安装）
  typescript/      # TypeScript/JavaScript 特定模式和工具
...
```bash
# 在仓库中运行 Codex CLI — AGENTS.md 和 .codex/ 会自动检测
codex
