...
✨ **搞定！** 你现在可以访问 26 个智能体、108 项技能和 57 条命令。
...
|   |-- typescript-reviewer.md # TypeScript/JavaScript 代码审查（新增）
|
|-- skills/           # 工作流定义与领域知识
...
* 语言特定技能（Rust, C#, Kotlin, Java）—— 已包含 Go, Python, Perl, Swift 和 TypeScript
* 框架特定配置（Rails, FastAPI, NestJS）—— 已包含 Django, Spring Boot, Laravel
...
|---------|-------------|----------|--------|
| 智能体 | ✅ 26 个智能体 | ✅ 12 个智能体 | **Claude Code 领先** |
| 命令 | ✅ 57 条命令 | ✅ 31 条命令 | **Claude Code 领先** |
| 技能 | ✅ 108 项技能 | ✅ 37 项技能 | **Claude Code 领先** |
...
| **规则** | 34 条 (通用 + 语言) | 34 条 (YAML 前置元数据) | 基于指令 | 13 条指令 |
