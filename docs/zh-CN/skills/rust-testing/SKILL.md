---
name: rust-testing
description: Rust测试模式包括单元测试、集成测试、异步测试、基于属性的测试、模拟测试和覆盖率分析。遵循测试驱动开发（TDD）方法论。
origin: ECC
---

# Rust 测试模式

遵循 TDD 方法编写可靠、可维护测试的综合 Rust 测试模式。
...
3. **模拟依赖项** — 使用 mockall 来隔离被测试单元
4. **运行测试（RED）** — 验证测试按预期失败
5. **实现（GREEN）** — 编写最少的代码使其通过
6. **重构** — 在保持测试通过的同时改进代码
7. **检查覆盖率** — 使用 cargo-llvm-cov，目标覆盖率 80% 以上
