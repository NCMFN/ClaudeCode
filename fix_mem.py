...
# Subsample time to reduce rows (take 1 day every 3 days) to save memory during df conversion
print("Subsampling data to save memory...")
ds = ds.isel(day=slice(None, None, 3))
