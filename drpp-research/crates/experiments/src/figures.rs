...
fn f01_drpp_attack_probability_vs_k(res_a: &[ResultA]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F01_drpp_attack_probability_vs_k.png", (1500, 800))
        .into_drawing_area();
    root.fill(&WHITE)?;
...
fn f02_collusion_attack_vs_k(res_b: &[ResultB]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F02_collusion_attack_vs_k.png", (1500, 800))
        .into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f03_full_comparison(res_a: &[ResultA], res_b: &[ResultB], res_c: &[ResultC]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F03_full_comparison.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
        .caption(
...
fn f04_3d_surface_attack_k_n(res_b: &[ResultB]) -> Result<()> {
    ...
    let root = BitMapBackend::new("output/figures/F04_3d_surface_attack_k_n.png", (1000, 1000))
        .into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f05_heatmap_collusion_k_n(_res_b: &[ResultB]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F05_heatmap_collusion_k_n.png", (1000, 1000))
        .into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f06_security_usability_tradeoff(_res_a: &[ResultA], _res_e: &[ResultE]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F06_security_usability_tradeoff.png", (1500, 800))
        .into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
...
fn f07_roc_knock(res_d: &[ModalityResult]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F07_roc_knock.png", (1000, 1000)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f08_roc_touch(res_d: &[ModalityResult]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F08_roc_touch.png", (1000, 1000)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f09_roc_gesture(res_d: &[ModalityResult]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F09_roc_gesture.png", (1000, 1000)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f10_confusion_matrix_combined(_res_d: &[ModalityResult]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F10_confusion_matrix_combined.png", (1000, 1000))
        .into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
...
fn f11_feature_histograms() -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F11_feature_histograms.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
}
...
fn f12_latency_boxplot(_res_e: &[ResultE]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F12_latency_boxplot.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
}
...
fn f14_accuracy_vs_noise(res_d: &[ModalityResult]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F14_accuracy_vs_noise.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f15_monte_carlo_convergence(res_h: &[ConvergencePoint]) -> Result<()> {
    let root = BitMapBackend::new("output/figures/F15_monte_carlo_convergence.png", (1500, 800))
        .into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f16_multimodal_bar(res_f: &[ResultF]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F16_multimodal_bar.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f17_dos_simulation(res_g: &[ResultG]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F17_dos_simulation.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
...
fn f18_ablation_study(_res_i: &[ResultI]) -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F18_ablation_study.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
}
...
fn f19_radar_comparison() -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F19_radar_comparison.png", (1000, 1000)).into_drawing_area();
    root.fill(&WHITE)?;
    // Radar logic...
    root.present()?;
    Ok(())
...
fn f20_sequence_diagram() -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F20_sequence_diagram.png", (1000, 1000)).into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
}
...
fn f21_architecture_diagram() -> Result<()> {
    let root =
        BitMapBackend::new("output/figures/F21_architecture_diagram.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    root.present()?;
    Ok(())
}
...
fn f22_cdf_guesses() -> Result<()> {
    let root = BitMapBackend::new("output/figures/F22_cdf_guesses.png", (1500, 800)).into_drawing_area();
    root.fill(&WHITE)?;
    let mut chart = ChartBuilder::on(&root)
