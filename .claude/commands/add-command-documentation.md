...
description: Workflow command scaffold for add-command-documentation in everything-claude-code.
allowed_tools: ["Bash", "Read", "Write", "Grep", "Glob"]
---

# /add-command-documentation

Use this workflow when working on **add-command-documentation** in `everything-claude-code`.
