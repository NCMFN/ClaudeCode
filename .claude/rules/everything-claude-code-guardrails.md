...
- add-new-skill: Adds a new skill to the repository, following the SKILL.md template and optionally cross-harness copies.
- add-new-agent: Adds a new agent to the repository, registers it in documentation and mapping files.
