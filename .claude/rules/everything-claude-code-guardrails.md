...
- add-documentation-command-or-skill: Adds new documentation for a command, skill, or agent to the ECC bundle.
- add-ecc-bundle-config-or-policy: Adds or updates configuration, policy, or rules files for the ECC bundle.
