...
- add-new-agent-or-skill: Adds a new agent or skill to the codebase, including documentation and configuration.
- add-or-update-command: Adds a new command or updates an existing command, often with related documentation and tests.
