...
- add-or-update-skill-documentation: Adds a new skill or updates documentation for an existing skill, typically by creating or modifying a SKILL.md file under skills/ or docs/[lang]/skills/.
