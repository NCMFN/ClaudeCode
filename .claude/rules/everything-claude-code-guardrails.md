...
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the ECC system by creating a corresponding markdown file describing the addition.
