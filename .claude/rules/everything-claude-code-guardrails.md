...
- add-command-or-skill-or-agent-or-workflow: Adds a new command, skill, agent, or workflow to the system by creating or updating the corresponding markdown definition file.
