...
- add-new-skill: Adds a new skill to the everything-claude-code project, including documentation and configuration.
- add-new-agent: Adds a new agent to the everything-claude-code project, including documentation and configuration.
