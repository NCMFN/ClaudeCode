...
- add-new-agent-command: Adds a new agent command to the system, documenting the process for adding agents.
- add-new-skill-command: Adds a new skill command to the system, documenting the process for adding skills.
